  ...
  <main class="container">
    ...
    <section class="services-grid" aria-label="Layanan utama - grid 1">
      ...
      <article class="service-card" aria-labelledby="s-poli">
        ...
        <p class="short">Rawat jalan untuk observasi, diagnosis, dan pengobatan tanpa menginap. Cocok untuk konsultasi, vaksinasi, dan perawatan ringan.</p>
        <small class="muted">Fitur: rawat jalan, vaksinasi; sitologi, dermatologi, hematologi; radiologi, USG, EKG.</small>
      </article>
     ...
     {{--  --}}
      <article class="service-card" aria-labelledby="s-bedah">
        ...
        <details>
          ...
          <small class="muted">Minor: jahit luka, kastrasi, othematoma, scaling/root planing, ekstraksi gigi.</small>
          <br><br>
          <small class="muted">Mayor: operasi abdomen, OHE, sectio caesar, perbaikan fraktur, eksisi tumor, hernia.</small>
        </details>
      </article>
    </section>
    ...
    <section class="services-grid" aria-label="Layanan penunjang - grid 2">
      ...
      <article class="service-card span-2" aria-labelledby="s-groom">
        ...
        <p class="short">Perawatan estetika dan kesehatan dasar; satu layanan terintegrasi dengan layanan terpisah per-species.</p>

        <div style="display:grid; gap:0.75rem; grid-template-columns: repeat(auto-fit,minmax(160px,1fr)); margin-top:0.5rem;">
          <section>
