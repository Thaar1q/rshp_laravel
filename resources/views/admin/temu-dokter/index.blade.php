                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped mb-0">
                            ...
                            <tbody>
                                @forelse($data as $temu)
                                                    ...
                                                    <div class="modal-body">
                                                            ...
                                                            <select name="idrole_user" class="form-control" required>
                                                                @foreach ($dokters as $dokter)
                                                                    <option value="{{ $dokter->idrole_user }}"
                                                                        {{ $temu->idrole_user == $dokter->idrole_user ? 'selected' : '' }}>
                                                                        {{ $dokter->user->nama }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="status" class="form-control" required>
                                                                <option value="0"
                                                                    {{ $temu->status == '0' ? 'selected' : '' }}>
                                                                    Menunggu</option>
                                                                <option value="1"
                                                                    {{ $temu->status == '1' ? 'selected' : '' }}>
                                                                    Selesai</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $temu->idtemu_dokter }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form
                                                    action="{{ route('admin.temu-dokter.delete', $temu->idtemu_dokter) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="modal-header">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-muted">Belum ada jadwal temu dokter
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
