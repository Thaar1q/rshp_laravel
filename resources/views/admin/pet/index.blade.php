                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#modalEditPet{{ $pet->idpet }}" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </button>

                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalHapusPet{{ $pet->idpet }}" title="Hapus">
                                                ...
                                                <form method="post" action="{{ route('admin.pet.edit', $pet->idpet) }}">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <select name="jenis_kelamin" class="form-select mb-2">
                                                            <option value="J"
                                                                {{ $pet->jenis_kelamin == 'J' ? 'selected' : '' }}>
                                                                Jantan</option>
                                                            <option value="B"
                                                                {{ $pet->jenis_kelamin == 'B' ? 'selected' : '' }}>
                                                                Betina</option>
                                                        </select>
                                                        ...
                                                        <select name="idpemilik" class="form-select mb-2">
                                                            @foreach ($pemilik as $p)
                                                                <option value="{{ $p->idpemilik }}"
                                                                    {{ $p->idpemilik == $pet->idpemilik ? 'selected' : '' }}>
                                                                    {{ $p->user->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
