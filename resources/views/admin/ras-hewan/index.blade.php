                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#modalEditRas{{ $ras->idras_hewan }}" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </button>

                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalHapusRas{{ $ras->idras_hewan }}" title="Hapus">
                                                        ...
                                                        <select name="idjenis_hewan" class="form-select">
                                                            @foreach ($jenis as $j)
                                                                <option value="{{ $j->idjenis_hewan }}"
                                                                    {{ $j->idjenis_hewan == $ras->idjenis_hewan ? 'selected' : '' }}>
                                                                    {{ $j->nama_jenis_hewan }}
                                                                </option>
                                                            @endforeach
                                                        </select>
