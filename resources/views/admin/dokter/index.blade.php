                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Alamat <span
                                                                    class="text-danger">*</span></label>
                                                            <textarea name="alamat" class="form-control" rows="3" required>{{ $dokter->alamat }}</textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="jenis_kelamin" class="form-control" required>
                                                                <option value="L"
                                                                    {{ $dokter->jenis_kelamin == 'L' ? 'selected' : '' }}>
                                                                    Laki-laki</option>
                                                                <option value="P"
                                                                    {{ $dokter->jenis_kelamin == 'P' ? 'selected' : '' }}>
                                                                    Perempuan</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <form action="{{ route('admin.dokter.delete', $dokter->id_dokter) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Apakah Anda yakin ingin menghapus data dokter
                                                            <strong>{{ $dokter->user->nama }}</strong>?
                                                        </p>
                ...
                <form action="{{ route('admin.dokter.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="bidang_dokter" class="form-control"
                                placeholder="Contoh: Bedah, Umum" required>
                        </div>
                        <div class="mb-3">
