                        ...
                        <table class="table table-hover table-striped mb-0">
                            ...
                            <tbody>
                                @foreach ($data as $kode)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#modalEditKode{{ $kode->idkode_tindakan_terapi }}" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </button>

                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalHapusKode{{ $kode->idkode_tindakan_terapi }}" title="Hapus">
                                    ...
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="modalEditKode{{ $kode->idkode_tindakan_terapi }}"
                                        tabindex="-1">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <select name="idkategori_klinis" class="form-select">
                                                            @foreach ($kategori as $k)
                                                                <option value="{{ $k->idkategori_klinis }}"
                                                                    {{ $k->idkategori_klinis == $kode->idkategori_klinis ? 'selected' : '' }}>
