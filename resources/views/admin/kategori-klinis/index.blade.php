                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#modalEditKategoriKlinis{{ $kategori->idkategori_klinis }}" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </button>

                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalHapusKategoriKlinis{{ $kategori->idkategori_klinis }}" title="Hapus">
